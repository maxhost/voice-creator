...
export const interview = {
  ...
  panel: {
    ...
    instructionsDesktop: 'Maintenez la barre d\'espace pour parler',
    instructionsMobile: 'Maintenez le bouton pour parler',
  },
  onboarding: {
    ...
    languageHint: 'L\'IA parlera et répondra dans cette langue',
