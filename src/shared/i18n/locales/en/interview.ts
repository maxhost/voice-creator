...
export const interview = {
  ...
  panel: {
    ...
    instructionsDesktop: 'Press and hold spacebar to talk',
    instructionsMobile: 'Hold the button to talk',
  },
  onboarding: {
    ...
    languageHint: 'The AI will speak and respond in this language',
